...
export class EventoLigaService {
  ...
  obtenerListado(criterioBusqueda: any): Observable<any> {
    ...
    const url = `${this.urlAccesos}${Constantes.api.account.TableroPosiciones}`;
  ...
  obtenerMaestros(criterioBusqueda: any): Observable<any> {
    const parametrosGet = this._convertDataHelper.obtenerParametrosGet(criterioBusqueda);
    const url = `${this.urlAccesos}${Constantes.api.account.Maestros}`;
    return this._httpClient.get<any>(
      url,
      { params: parametrosGet }
    ).
  ...
  obtenerResumenes(criterioBusqueda: any): Observable<any> {
    const parametrosGet = this._convertDataHelper.obtenerParametrosGet(criterioBusqueda);
    const url = `${this.urlAccesos}${Constantes.api.account.EventosLiga}`;
    return this._httpClient.get<any>(
      url,
      { params: parametrosGet }
    ).
  ...
  obtenerEquipos(criterioBusqueda: any): Observable<any> {
    const parametrosGet = this._convertDataHelper.obtenerParametrosGet(criterioBusqueda);
    const url = `${this.urlAccesos}${Constantes.api.account.Equipos}`;
    return this._httpClient.get<any>(
      url,
      { params: parametrosGet }
    ).
  ...
  obtenerTemporadasByLiga(criterioBusqueda: any): Observable<any> {
    const parametrosGet = this._convertDataHelper.obtenerParametrosGet(criterioBusqueda);
    const url = `${this.urlAccesos}${Constantes.api.account.Temporadas}`;
    return this._httpClient.get<any>(
      url,
      { params: parametrosGet }
    ).
